...
def get_information_work():
    ...
    channel_videos_combobox = customtkinter.CTkComboBox(channel_frame, values=video_watch_urls)
    channel_videos_combobox.grid(row=10, column=0, columnspan=2, padx=PADDING_X, pady=PADDING_Y, sticky="sw")
